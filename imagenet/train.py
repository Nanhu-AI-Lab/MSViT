...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='MSFormer_10_384', type=str, metavar='MODEL',
    ...
    parser.add_argument('--output_dir', default='./output_dir_MSformer',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/dev/shm/output_dir_MSformer',
...
def main(args):
    ...
    model = msformer.__dict__[args.model](T=args.time_step)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch % 10== 0 and test_stats["acc1"] > max_accuracy) or epoch==199:
            if args.output_dir:
                misc.save_model(
