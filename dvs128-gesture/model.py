...
class Token_MS_Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, ms_scale=None, attn_drop=0., proj_drop=0., sr_ratio=1):
        ...
        self.p_lif = MultiStepLIFNode(tau=2.0, detach_reset=True, backend='cupy')
...
class PatchEmbedInit(nn.Module):
    def __init__(self, img_size_h=128, img_size_w=128, patch_size=4, in_channels=2, embed_dims=256):
        ...
        self.proj2_conv = nn.Conv2d(embed_dims//1, embed_dims // 1, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.proj3_conv = nn.Conv2d(embed_dims // 1, embed_dims, kernel_size=3, stride=1, padding=1, bias=False)
