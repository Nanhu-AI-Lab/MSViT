...
'''
/data/datasets/DVS128Gesture

python train_imagenet.py --tb --amp --output-dir ./logs --model PlainNet --device cuda:0 --lr-step-size 64 --epoch 192 --T_train 12 --T 16 --data-path /data/datasets/DVS128Gesture

python train_imagenet.py --tb --amp --output-dir ./logs --model SEWResNet --connect_f ADD --device cuda:0 --lr-step-size 64 --epoch 192 --T_train 12 --T 16 --data-path /data/datasets/DVS128Gesture
